...
return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 1 => ${($_ = isset($this->services['security.authentication.listener.jwt.api']) ? $this->services['security.authentication.listener.jwt.api'] : $this->load('getSecurity_Authentication_Listener_Jwt_ApiService.php')) && false ?: '_'};
