...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'lexik_jwt_authentication.extractor.authorization_header_extractor.api' => 'getLexikJwtAuthentication_Extractor_AuthorizationHeaderExtractor_ApiService.php',
            ...
            'lexik_jwt_authentication.security.authentication.entry_point.api' => 'getLexikJwtAuthentication_Security_Authentication_EntryPoint_ApiService.php',
            ...
            'security.authentication.listener.json.login' => 'getSecurity_Authentication_Listener_Json_LoginService.php',
            'security.authentication.listener.jwt.api' => 'getSecurity_Authentication_Listener_Jwt_ApiService.php',
            ...
            'security.authentication.provider.jwt.api' => 'getSecurity_Authentication_Provider_Jwt_ApiService.php',
            ...
            'security.request_matcher.yg2ff4m' => 'getSecurity_RequestMatcher_Yg2ff4mService.php',
        ...
        $this->privates = array(
            ...
            'lexik_jwt_authentication.extractor.authorization_header_extractor.api' => true,
            ...
            'security.request_matcher.yg2ff4m' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('gVizm2UlrG', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7J-sv3LoXe', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JuSAfeq2sD', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('50NcLjry7L', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 2 => ${($_ = isset($this->services['security.authentication.provider.dao.login']) ? $this->services['security.authentication.provider.dao.login'] : $this->load('getSecurity_Authentication_Provider_Dao_LoginService.php')) && false ?: '_'};
            ...
            yield 4 => ${($_ = isset($this->services['security.authentication.provider.jwt.api']) ? $this->services['security.authentication.provider.jwt.api'] : $this->load('getSecurity_Authentication_Provider_Jwt_ApiService.php')) && false ?: '_'};
        }, 5), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'rainyle83@gmail.com',
            'mailer_password' => 'lbv23483',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'rainyle83@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'lbv23483',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'rainyle83@gmail.com' => 'rainyle83@gmail.com',
            ),
            ...
            'lexik_jwt_authentication.pass_phrase' => 'happyapi',
